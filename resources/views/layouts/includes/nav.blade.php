...
<ul id="slide-out" class="side-nav fixed leftside-navigation">
    ...
    <li class="bold"><a href="{{ URL::to('user') }}" class="waves-effect waves-cyan"><i class="mdi-social-people"></i> Users</a>
    <li class="bold"><a href="{{ URL::to('admin/post') }}" class="waves-effect waves-cyan"><i class="mdi-av-my-library-books"></i> Post</a>
    </li>
    <li class="no-padding">
    ...
    <li><a href="{{ URL::to('/auth/logout') }}"><i class="mdi-action-input"></i> Logout</a>
    </li>                 
</ul>
