                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m12 l12">
                            <h5 class="breadcrumbs-title">Users Management</h5>
                            <br/>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="section">
                    ...
                    <div id="responsive-table">
                        <h4 class="header">Users Dashboard</h4>
                        <div class="row">
                            <div class="col s12 m12 l12 ">
                                        ...
                                        @if($data->count() > 0)
                                            @foreach($data as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ URL::to('user/view/'.$item->id) }}">
                                                            <i class="mdi-action-pageview"></i>
                                                        </a>
                                                        <a href="{{ URL::to('user/edit/'.$item->id) }}">
                                                        ...
                                                        <div id="modaldelete-{{ $item->id }}" class="modal">
                                                            ...
                                                            <div class="modal-footer red">
                                                                <a href="{{ URL::to('user/delete/'.$item->id) }}"  class="waves-effect waves-green btn-flat white-text modal-action modal-close">Yes</a>
                ...
                <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
                    <a class="btn-floating btn-large red" href="{{ URL::to('user/create') }}">
